...
Synthesises all upstream signals (prompt intent, transformation results,
coverage metrics) into a single reliance judgment.
...
1. reliance_band: "low", "moderate", or "high"
   - "low": AI used primarily for learning; student wrote independently
   - "moderate": AI influenced structure or phrasing but student contributed substantially
   - "high": large portions of the assignment appear derived from AI output
...
def judge_reliance(
    ...
    """Produce an overall reliance judgment from aggregated analysis signals."""
...
"""
    ...
    logger.info("Judging overall reliance via %s", settings.llm_model)
