"""Pydantic models used by the analysis pipeline.

Preserved from the original models.py -- these are the schemas used by the
parsers, chunkers, retrieval, LLM analysis passes, scoring, and reporting.
"""
...
class PromptIntentResult(BaseModel):
    explanation_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    brainstorming_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    outline_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    rewrite_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    debugging_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    direct_answer_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    full_assignment_generation_request: PromptIntentCategory = Field(default_factory=PromptIntentCategory)
    overall_intent_profile: Literal["learning_focused", "outsourcing_focused", "mixed"] = "mixed"
    notable_prompt_examples: List[NotablePromptExample] = Field(default_factory=list)
